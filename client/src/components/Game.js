...
class Game extends React.Component {
    ...
    init = () => {
        ...
        app.loader.add('pa', 'assets/tiles/path.png')
        app.loader.add('wa', 'assets/tiles/water.png')
        app.loader.add('na', 'assets/tiles/nature.png')
        app.loader.add('hi', 'assets/tiles/hills.png')
        app.loader.add('ro', 'assets/tiles/road.png')
        app.loader.add('ho', 'assets/tiles/houses.png')
        app.loader.add('fe', 'assets/tiles/fences.png')
