...
def calculate_pond_look(layer, x, y):
    ...
    if tiles_around[5] == 1 and tiles_around[7] == 1 and tiles_around[8] == 1: return "5"
    if tiles_around[1] == 1 and tiles_around[2] == 1 and tiles_around[5] == 1: return "6"
    if tiles_around[0] == 1 and tiles_around[1] == 1 and tiles_around[3] == 1: return "7"
    if tiles_around[3] == 1 and tiles_around[6] == 1 and tiles_around[7] == 1: return "8"
